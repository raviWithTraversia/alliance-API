...
// Define the schema
const vendorAirBookingLogSchema: Schema = new Schema(
    {
...
const VendorAirBookingLog = mongoose.model<IVendorLog>('VendorAirBookingLog', vendorAirBookingLogSchema);
export default VendorAirBookingLog;
