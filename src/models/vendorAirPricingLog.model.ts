...
// Define the schema
const vendorAirPricingLogSchema: Schema = new Schema(
    {
...
const VendorAirPricingLog = mongoose.model<IVendorLog>('VendorAirPricingLog', vendorAirPricingLogSchema);
export default VendorAirPricingLog;
