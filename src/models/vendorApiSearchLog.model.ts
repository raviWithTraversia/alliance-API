...
// Define the schema
const vendorApiSearchLogSchema: Schema = new Schema(
    {
...
const VendorApiSearchLog = mongoose.model<IVendorLog>('VendorApiSearchLog', vendorApiSearchLogSchema);
export default VendorApiSearchLog;
