...
// Define the schema
const vendorFareRuleLogSchema: Schema = new Schema(
    {
...
const VendorFareRuleLog = mongoose.model<IVendorLog>('VendorFareRuleLog', vendorFareRuleLogSchema);
export default VendorFareRuleLog;
