...
// Define the schema
const vendorGetSeatMapLogSchema: Schema = new Schema(
    {
...
const VendorGetSeatMapLog = mongoose.model<IVendorLog>('VendorGetSeatMapLog', vendorGetSeatMapLogSchema);
export default VendorGetSeatMapLog;
