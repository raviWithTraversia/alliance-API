...
// Define the schema
const vendorApiSsrLogSchema: Schema = new Schema(
    {
...
const VendorSsrLog = mongoose.model<IVendorLog>('VendorSsrLog', vendorApiSsrLogSchema);
export default VendorSsrLog;
